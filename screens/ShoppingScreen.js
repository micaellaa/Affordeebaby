...
const ShoppingScreen = () => {
  ...
  return (
    <View>
    <View style={{flex: 3, paddingHorizontal: 50, backgroundColor: COLORS.white}}>
      <View>
        <Text style={{fontSize: 25, fontWeight: 'bold', paddingHorizontal: 50}}>Welcome to</Text>
        <Text style={{fontSize: 38, color: COLORS.indigo, fontWeight: 'bold', paddingHorizontal: 50}}>
          Product Shop
          </Text>
          </View>
